...
test.describe("E2E Cart Control Tests", () => {
  let cart: cartControl;
  let check: checkout;
  let loginReg: loginRegister;

  test.beforeEach("Setup", async ({ page }) => {
    await page.goto("http://automationexercise.com");
    cart = new cartControl(page);
    check = new checkout(page);
    loginReg = new loginRegister(page);
  });

  test("Test Case 12: Add products to cart", async () => {
    await cart.openPage.goto();
    await cart.openPage.openProductsPage();
    await cart.addProduct();
  });

  test("Test Case 13: Add various of one product to cart", async () => {
    await cart.openPage.goto();
    await cart.openPage.openProductsPage();
    await cart.addManyProducts();
  });

  test("Test Case 14: Sign up on checkout", async () => {
    await cart.openPage.goto();
    await cart.openPage.openProductsPage();
    await cart.addProduct();
  ...
  test("Test Case 15: Sign up before checkout", async () => {
  ...
  test("DEBUG CASE 1: JUST sign up", async () => {
    await loginReg.openPage.goto();
    await loginReg.openPage.openSignUpLoginPage();
    await loginReg.signUp();
  });
  ...
  test("Test Case 16: LOG in before checkout", async () => {
    await loginReg.openPage.goto();
    await loginReg.openPage.openSignUpLoginPage();
  ...
  test("Test Case 19: View and Cart Brand Products", async () => {
    await cart.openPage.goto();
    await cart.verifyCategoriesAndBrands();
    await cart.gotoWomenAndMen();
  ...
  // THIS IS TO ALLOW CONTINOUS TESTING
  test("DEBUG CASE 2: JUST sign up", async () => {
    await loginReg.openPage.goto();
    await loginReg.openPage.openSignUpLoginPage();
    await loginReg.signUp();
  });

  test("Test Case 20: Search Products and Cart After Login", async () => {
    await cart.openPage.goto();
    await cart.openPage.openProductsPage();
  ...
  test("Test Case 21: Add review", async () => {
    await cart.openPage.goto();
    await cart.openPage.openProductsPage();
    await cart.reviewProduct();
  });

  test("Test Case 22: Add to Cart from Recommended", async () => {
    await cart.openPage.goto();
    await cart.addRecommended();
  });

  // THIS IS TO ALLOW CONTINOUS TESTING
  test("DEBUG CASE 3: log and delete", async () => {
    await loginReg.openPage.goto();
    await loginReg.openPage.openSignUpLoginPage();
    await loginReg.logIn();
    await loginReg.deleteAccount();
  ...
  test("Test Case 23: Verify Adress Details on Checkout", async () => {
    await cart.openPage.goto();
    await loginReg.openPage.openSignUpLoginPage();
    await loginReg.signUp();
  ...
  test("Test Case 24: Verify Adress Details on Checkout", async () => {
    await cart.openPage.goto();
    await cart.openPage.openProductsPage();
    await cart.addProduct();
    await check.checkOut();
